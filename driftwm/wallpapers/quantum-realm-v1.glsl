...
const vec3 BASE = vec3(0.024, 0.031, 0.051);   // #06080d
const vec3 MIST = vec3(0.42, 0.50, 0.62);      // blue-grey
    ...
    for (int cy = -1; cy <= 1; cy++) {
        for (int cx = -1; cx <= 1; cx++) {
            ...
            if (h > 0.68) {
                ...
                vec3 pcol =
                    hue < 0.30 ? vec3(0.55, 0.18, 0.52) :   // magenta
                    hue < 0.55 ? vec3(0.16, 0.42, 0.55) :   // cyan
                    hue < 0.82 ? vec3(0.34, 0.22, 0.60) :   // violet
