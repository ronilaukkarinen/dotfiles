...
- Every write to a task system is reported back with its identifier and URL, in the message that reports the work. Creating, editing, reassigning, re-prioritising, rescheduling and closing all count, in Linear, Todoist and Akiflow alike. Never "created a ticket" or "moved it to tomorrow" without the id and link beside it - an unnamed write is one I cannot find, check or undo
