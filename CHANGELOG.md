...
* Quantum realm: sparser and fainter energy filaments (dense bright veins read as snakes at far zoom-out), subtler starfield through the fog gaps, gaps close entirely below ~35% zoom (`u_zoom`-aware alpha: shrunken gap windows at overview read as punched holes), gap windows open only where fog gets truly thin (threshold 0.46 to 0.58 to 0.70, alpha floor 0.40: stars barely show at 100%), and distant lightning boosted (60% of cells, 12-30 s periods, brighter flashes)
